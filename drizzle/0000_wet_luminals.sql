-- Note: auth.users is owned by Supabase. Drizzle declares it in its schema
-- only so we can foreign-key into it; we do NOT create it here.
...
CREATE TABLE "organizations" (
	...
	"default_min_quantity" numeric DEFAULT '1',
